...
import { Stethoscope, Brain, AlertTriangle, FileText, Activity, Play } from 'lucide-react';

type DifferentialItem = { dx: string; prob: number };
...
export default function RealDiagDemo() {
  ...
  const cinematicSections: { title: string; ref: RefObject<HTMLDivElement | null>; text: string }[] = [
    {
      ...
      <div className='max-w-7xl mx-auto space-y-6'>
        ...
        <div ref={diagnosticRef} className='grid lg:grid-cols-4 gap-6'>
          <Card>
            ...
            <div ref={roiRef} className='mt-6 bg-teal-50 border border-teal-200 rounded-2xl p-5'>
