...
def send_password_reset_email(email: str, token: str, full_name: Optional[str] = None) -> bool:
    ...
    try:
        ...
        msg = MIMEMultipart("alternative")
        msg["Subject"] = "Reset your RealDiag password"
        msg["From"] = FROM_EMAIL
        msg["To"] = email
...
We received a request to reset the password for your RealDiag account.
...
<head>
    <style>
        ...
        .content {{ background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px; }}
        .button {{ display: inline-block; background: #0d9488; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; margin: 20px 0; }}
        .footer {{ text-align: center; margin-top: 20px; color: #666; font-size: 12px; }}
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset the password for your RealDiag account. Click the button below to choose a new password.</p>
        ...
        <div class="footer">
            <p>© RealDiag. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
